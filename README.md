...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3103%20cases-brightgreen" alt="3103 测试用例" />
...
- 测试：Vitest（服务 / 量化 / 研究 Agent / 前端组件，3103 用例 / 228 个测试文件，行覆盖 94.7%）+ Playwright（E2E 9 用例）+ GitHub Actions CI（质量门禁 + 覆盖率阈值 + E2E）
...
```bash
npm test              # Vitest 全量单测（3103 用例 / 228 个测试文件：服务 / 量化 / 研究 Agent / 前端组件）
